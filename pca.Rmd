...
```{r, pca}
library(tidyverse)
pca <- read.table("/Users/leump/Desktop/merge.eigenvec", header = F)
eigval <- read.table("/Users/leump/Desktop/merge.eigenval", header = F)
...
sample <- read.table("/Users/leump/Desktop/sample.txt", header = F)
...
sample <- read.csv("/Users/leump/Desktop/sample.csv", row.names = 1, check.names = F)
